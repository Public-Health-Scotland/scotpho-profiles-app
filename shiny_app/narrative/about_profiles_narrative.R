...
about_pa_text <- navset_pill_list(
  ...
  nav_panel(
    ...
    p("The Physical Activity profile, produced in collaboration within the ", 
      ...
      ". The indicator domains Active Travel, Active Places & Spaces, Active Places of Learning, Sport and Active Recreation and Overarching Indicators map to the ",
    ...
    p("Indicators are available at health board and council level depending on 
      data source. Deprivation splits are available for Scotland, and health boards 
      and councils where available. The  population groups tab contains breakdowns 
      of the indicators for councils and health boards by age group 
      (16-64 and 65+ years), sex, disability status, urban-rural classification 
      and equivalised income. These population group splits aid users in understanding 
      how different groups engage with physical activity and how well local services cater to 
      these groups."),
