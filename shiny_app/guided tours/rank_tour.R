...
guide_rank<- Cicerone$
  ...
  step(
    ...
    "This map allows for spatial comparison of areas across Scotland. Darker shading represents higher values for the selected indicator with lighter shading representing lower values.<br> 
