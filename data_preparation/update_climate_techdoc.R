...
update_climate_techdoc <- function(load_test_indicators=FALSE, create_backup=FALSE) {
  ...
  technical_doc_raw <- read.xlsx(
    xlsxFile = "/PHI_conf/ScotPHO/Profiles/Data/Climate Data/Technical_Document_Climate.xlsx", 
    sheet = "Raw", 
    sep = " ") |>
    clean_names()
  ...
  ## Clean date columns ----- ################## COME BACK TO THIS!! SORT DATE COLUMNS!
